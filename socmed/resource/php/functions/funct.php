                    ...
                    if($validation->passed()){
                        ...
                        if($login){
                            if($user->data()->groups == 1){
                                 Redirect::to('studentportal.php');
                                echo $user->data()->groups;
                            }else if($user->data()->groups == 2){
                                Redirect::to('adminportal.php');
                            }else{
...
function friendsProfilePic(){
    $view = new view();
    if($view->getFriendsdpSRA()!=="" || $view->getFriendsdpSRA()!==NULL){
        echo "<img class='rounded-circle profpic img-thumbnail ml-3' alt='100x100' src='data:".$view->getFriendsMmSRA().";base64,".base64_encode($view->getFriendsdpSRA())."'/>";
    }else{
        echo "<img class='rounded-circle profpic img-thumbnail' alt='100x100' src='resource/img/user.jpg'/>";
    }
}
