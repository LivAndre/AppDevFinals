...
<body>
        ...
        <div class="row">
            <div class="col-md-2 border pr-5">
                <?php  friendsProfilePic();?>
                <h6 class ="text-center mt-4 text-primary">Account Name: <?php echo $friend->data()->name ?></h6>
                <h6 class ="mt-4 text-secondary">Account Registered: <br><?php echo $friend->data()->joined ?></h6>
                <h6 class ="mt-4 text-secondary">Account Email: <br><?php echo $friend->data()->email ?></h6>
            </div>
            <div class="col-md-8 border pr-5">
                ...
                $viewtable->viewFriendsPost($friendId);
